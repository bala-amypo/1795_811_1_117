...
public class UserAccountController {
    ...
    @PostMapping
    public ResponseEntity<UserAccount> create(@RequestBody UserAccount u) { return ResponseEntity.ok(service.createUser(u)); }

    @GetMapping
    public ResponseEntity<List<UserAccount>> all() { return ResponseEntity.ok(service.getAllUsers()); }
}